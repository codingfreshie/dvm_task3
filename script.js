 ...
 function change_image(){
    ...
    logo1.style.width = "49.9px";
    logo1.style.height = "47.5px";
...
var divName = 'divtoshow'; // div that is to follow the mouse (must be position:absolute)
 ...
 var prevScrollpos = this.window.scrollY;
...
var image1 = document.querySelector(".part7 .image");
var image2 = document.querySelector(".part7 .image2");
var image3 = document.querySelector(".part7 .image3");
var part7 = document.querySelector(".part7");
var h1 = document.querySelector("#h1")
window.addEventListener("scroll", function(){
   let position = this.window.scrollY;
   // let position = part7.scrollY;
   image1.style.top = position*-0.12 +"px";
   // image1.style.border = "2px red solid";
   image2.style.top = position*-0.12 +"px";
   image3.style.top = position*-0.12 +"px";
   // h1.style.top = position*0.12 + "px";
})